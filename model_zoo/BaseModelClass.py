...
class BaseModel(nn.Module, ABC):
    ...
    def restore_checkpoint(self, ckpt_file, optimizer=None, lr_scheduler=None):
        r"""
    ...
    def save_checkpoint(self,
        ...
        name = 'Epoch_{}_loss_{}.pth'.format(epoch, round(loss, 4))
        torch.save(ckpt_dict, os.path.join(directory, name))
        if self.best_loss > loss:
            self.best_loss = loss
            torch.save(ckpt_dict, os.path.join(directory, "BEST.pth"))
