...
import torch
from model_zoo.UnetPlusPlus.modules import (
    ResidualConv,
    ASPP,
    AttentionBlock,
    Upsample_,
...
class ResUnetPlusPlus(BaseModel):
    def __init__(self, channel, classes, filters=[8, 16, 32, 64, 128]):
        ...
        self.squeeze_excite1 = Squeeze_Excite_Block(filters[0], 8)
        ...
        self.output_layer = nn.Sequential(nn.Conv3d(filters[0], classes, 1))
